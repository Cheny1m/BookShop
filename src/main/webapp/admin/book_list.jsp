...
<div class="container-fluid">
    ...
    <ul role="tablist" class="nav nav-tabs">
        ...
        <li <c:if test="${rtype==4 }">class="active"</c:if> role="presentation"><a href="book_list.action?pageNumber=1&rtype=4">折扣推荐</a></li>
    </ul>
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <c:choose>
                            <c:when test="${g.isDiscount }">
                                <a class="btn btn-info" href="book_change.action?bid=${g.bid}&rtype=4&method=remove&page=${rtype}">移出折扣</a>
                            </c:when>
                            <c:otherwise>
                                <a class="btn btn-primary" href="book_change.action?bid=${g.bid}&rtype=4&method=add&page=${rtype}">加入折扣</a>
                            </c:otherwise>
                        </c:choose>
