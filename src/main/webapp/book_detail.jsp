        ...
        <div class="single-grids">
            ...
            <div class="col-md-4 single-grid simpleCart_shelfItem">
                ...
                <div class="tag">
                    ...
                    <p>分类 : <a href="booktypes_list.action?pageNumber=1&btid=${book.btid}">${book.btname}</a></p>
                    <p>库存：${book.bstock}</p>
                    <p><a href="error/404error.jsp" style="color:blue">>>>点击购买电子书</a></p>
                </div>
                <p>${book.bmark}</p>
                <div class="galry">
                    <div class="prices">
			...
			<h3>猜你喜欢</h3>
				...
				<div class="product-grid single-product">
					...
					<div class="product-img b-link-stripe b-animate-go  thickbox">
						<img src="images/23535129_0.jpg" class="img-responsive" alt="">
						<div class="b-wrapper">
